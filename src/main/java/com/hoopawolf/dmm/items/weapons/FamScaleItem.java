...
public class FamScaleItem extends Item
{
    ...
    {
        tooltip.add(new TranslationTextComponent(I18n.format("tooltip.vrm:fam1")).func_240703_c_(field_240709_b_.func_240712_a_(TextFormatting.LIGHT_PURPLE)));
        tooltip.add(new TranslationTextComponent(I18n.format("tooltip.vrm:fam2")).func_240703_c_(field_240709_b_.func_240722_b_(true).func_240712_a_(TextFormatting.GRAY)));
        tooltip.add(new TranslationTextComponent(I18n.format("tooltip.vrm:fam3")).func_240703_c_(field_240709_b_.func_240722_b_(true).func_240712_a_(TextFormatting.GRAY)));
        tooltip.add(new TranslationTextComponent(I18n.format("tooltip.vrm:fam4") + ((getSacrificeCoolDown(stack) > 0) ? " [" + (getSacrificeCoolDown(stack) / 20) + "s]" : "")).func_240703_c_(field_240709_b_.func_240722_b_(true).func_240712_a_(((getSacrificeCoolDown(stack) > 0) ? TextFormatting.DARK_GRAY : TextFormatting.GRAY))));
    }
}
