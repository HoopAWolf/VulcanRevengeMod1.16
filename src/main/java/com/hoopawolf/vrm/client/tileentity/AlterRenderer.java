...
@OnlyIn(Dist.CLIENT)
public class AlterRenderer extends TileEntityRenderer<AlterTileEntity>
{
    private static final float field_229057_l_ = (float) (Math.sqrt(3.0D) / 2.0D);

    public AlterRenderer(TileEntityRendererDispatcher rendererDispatcherIn)
    {
    ...
    @Override
    public void render(AlterTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
    {
