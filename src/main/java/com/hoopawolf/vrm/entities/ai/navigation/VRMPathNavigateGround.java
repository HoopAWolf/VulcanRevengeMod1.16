...
public class VRMPathNavigateGround extends GroundPathNavigator
{
    static final float EPSILON = 1.0E-8F;

    public VRMPathNavigateGround(MobEntity entity, World world)
    {
        super(entity, world);
    }
    ...
    {
        this.nodeProcessor = new VRMWalkNodeProcessor();
        this.nodeProcessor.setCanEnterDoors(true);
        return new VRMPathFinder(this.nodeProcessor, p_179679_1_);
    }
