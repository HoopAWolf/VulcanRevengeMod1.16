...
public class SinStructurePiece
{
    public static final ResourceLocation SIN_STRUCTURE_LOC = new ResourceLocation(Reference.MOD_ID, "sinstructure");
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random)
    {
        ...
        pieceList.add(new SinStructurePiece.Piece(templateManager, SIN_STRUCTURE_LOC, pos, rotation));
    }
    ...
    public static class Piece extends TemplateStructurePiece
    {
        ...
        {
            super(StructureRegistryHandler.SIN_STRUCTURE_FEATURE, 0);
        ...
        {
            super(StructureRegistryHandler.SIN_STRUCTURE_FEATURE, tagCompound);
